    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((Button) view.findViewById(R.id.BtnUpdateUser)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("http://julianoblanco-001-site3.ctempurl.com/Home/Checkout?Email="+Email+"&Pass="+Password);
                Log.d("Site UpDate Dados: ", String.valueOf("http://julianoblanco-001-site3.ctempurl.com/Home/Checkout?Email="+Email+"&Pass="+Password));
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
